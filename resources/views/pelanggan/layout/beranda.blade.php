...
<html lang="en">
  <head>
    ...
    <title>Web Design Mastery | Warmindo Aroma</title>
  </head>
  <body>
    <nav>
      <div class="nav__header">
        <div class="logo nav__logo">
          <a href="#">Warmindo<span>Aroma</span></a>
        </div>
      ...
      <ul class="nav__links" id="nav-links">
        ...
        <li><a href="#chef">Tentang Kami</a></li>
    ...
    <header class="section__container header__container" id="home">
      <div class="header__image">
        <img src="https://i.ibb.co/L6Pvmbr/nasi-goreng.jpg" alt="header" />
      </div>
      <div class="header__content">
        <h1>Rasa Keluarga, Harga & Ramah <span>Dihati</span>.</h1>

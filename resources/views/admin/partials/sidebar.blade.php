        ...
        <div id="app-sidepanel" class="app-sidepanel sidepanel-hidden"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="home"><img class="logo-icon me-2" src="https://i.ibb.co/zhrvvPv/masak-mie-1.png" alt="logo"><span class="logo-text">Warmindo Aroma</span></a>
...
<script>
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function() {
            // Hapus semua kelas warna dari sidebar
            sidebar.classList.remove('sidebar-color-home', 'sidebar-color-menu', 'sidebar-color-order');

            // Dapatkan data-color link dan tambahkan ke kelas sidebar
